...
#         return input_ids
    ...
    dataset = FolderData(args.train_data_dir,args.pretrained_model_name_or_path,negative_prompt=args.negative_prompt,section0=args.section0,section1=args.section1,ip=instance_prompt)
...
#       {'adam': optimizer_2, 'none': optax.set_to_zero()}, label_fn)
    ...
    state = train_state.TrainState.create(apply_fn=text_encoder.__call__, params=text_encoder_params, tx=optimizer)
        ...
        for batch in train_dataloader:
            ...
            if global_step % args.accumulation_frequency == 0 and global_step > args.restart_from and jax.process_index() == 0:
                if global_step % args.ema_frequency == 0:
                  it = (global_step+args.restart_from)//(args.ema_frequency)
                  decay = args.ema
