...
#             save_(unet_params['time_embedding']['linear_1']['kernel'],'k3_post.npy')
    #         print("unet params post ---->" ,unet_params['time_embedding']['linear_1']['kernel'])
            unet_outputs = apply_fn_unet({"params": unet_params},noisy_latents, timesteps, encoder_hidden_states)
...
#             train_metric = jax_utils.unreplicate(train_metric)
        ...
        epochs.write(f"Epoch... ({epoch + 1}/{args.num_train_epochs} | Loss: {loss})")
