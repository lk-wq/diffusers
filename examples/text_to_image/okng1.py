...
#     train_rngs = jax.random.split(rng, jax.local_device_count())
    import random
    def train_step(unet_params, text_encoder_params, vae_params, batchi,batchp, train_rng):
    ...
    p_train_step = pjit(
        train_step,
        in_axis_resources=( unet_param_spec,text_param_spec,vae_param_spec,P("mp",None),P(None,None,'dp','mp'),None ),
        out_axis_resources=( unet_param_spec,None, None),
        donate_argnums=(0,),
    )
...
#                 with jax.default_matmul_precision('float32'):
                ...
                unet_params, train_metric, train_rngs = p_train_step(unet_params,text_params,vae_params ,bi, pixels,train_rngs)
