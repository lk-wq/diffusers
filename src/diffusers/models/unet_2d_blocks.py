...
from .resnet import Downsample2D, FirDownsample2D, FirUpsample2D, ResnetBlock2D, Upsample2D, ResnetBlock2DCircular, Upsample2DCircular
...
def get_up_block(
    ...
    elif up_block_type == "UpDecoderBlock2DCircular":
        return UpDecoderBlock2DCircular(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            add_upsample=add_upsample,
...
class UNetMidBlock2DCircular(nn.Module):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
...
class UpDecoderBlock2DCircular(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
